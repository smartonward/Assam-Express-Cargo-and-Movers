...
const marker = 'width: 4px;';
const nextMarker = '.pan-india-banner-large::before {';

const idx = css.indexOf(marker);
const endIdx = css.indexOf(nextMarker);

if (idx > -1 && endIdx > -1) {
  const perfect = `width: 4px;
  background-image: linear-gradient(var(--ice) 33%, rgba(255,255,255,0) 0%);
...
.pan-india-banner-section {
  padding: 40px 0 100px;
  background: var(--white);
}

.pan-india-banner-large {
